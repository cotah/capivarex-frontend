...
export default function StockRow({ symbol, name, price, change, positive }: StockRowProps) {
  return (
    <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 last:border-none">
      <div className="flex items-center gap-3 min-w-0">
        <span className="text-sm font-bold font-mono text-accent w-14 flex-shrink-0">
          {symbol}
        </span>
